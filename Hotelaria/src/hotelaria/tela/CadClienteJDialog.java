 ...
 */
public class CadClienteJDialog extends javax.swing.JDialog {
     ...
     */
    public CadClienteJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        iniciaTela();
    }
    ...
    private void initComponents() {
        ...
        tfDtCadastro = new javax.swing.JFormattedTextField();
        ...
        pnCadastro.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cadastro", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        try {
            tfDtCadastro.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##/##/####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        tfDtCadastro.setEnabled(false);
        ...
        pnCadastroLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnCadastroLayout.createSequentialGroup()
                ...
                .addGroup(pnCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(tfDtCadastro, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE)
                    .addComponent(tfRG))
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hotelaria/tela/Hotel.png"))); // NOI18N
    ...
    private void btAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAddActionPerformed
        try {
            ...
            cli.setCodigo(Integer.parseInt(tfCod.getText().trim()));
            cli.setCpf(tfCPF.getText().trim());
            cli.setDtCadastro(DateUtil.stringToDate(tfDtCadastro.getText().trim()));
            cli.setNome(tfNome.getText().trim());
            cli.setRg(tfRG.getText().trim());
            cli.setSexo(verificaSexo());
    ...
    private void tbClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbClienteMouseClicked
        ...
        try {
            cliente = cliDAO.getById((int) tbCliente.getValueAt(tbCliente.getSelectedRow(), 0));
        } catch (SQLException ex) {
            ex.printStackTrace();
        }
        novo();
        btAdd.setText("Atualizar");
        tfCod.setText(String.valueOf(cliente.getCodigo()));
        tfCPF.setText(cliente.getCpf());
        tfNome.setText(cliente.getNome());
        tfRG.setText(cliente.getRg());
        tfDtCadastro.setText(DateUtil.dateToString(cliente.getDtCadastro()));
    ...
    private void btSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSearchActionPerformed
        try {
            if (rbCodigo.isSelected() && tfFiltroCod.getText().trim().length() > 0) {
                Cliente cliente = cliDAO.getById(Integer.parseInt(tfFiltroCod.getText()));
                List<Cliente> clienteList = new ArrayList<>();
                clienteList.add(cliente);
                carregaTable(clienteList);
            } else if (rbNome.isSelected() && tfFiltroNome.getText().trim().length() > 0) {
                carregaTable(cliDAO.getByName(tfFiltroNome.getText()));
            } else {
                carregaTable(cliDAO.getAll());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadClienteJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void iniciaTela() {
        try {
            ...
            desabilitaCampos(false);
            carregaTable(cliDAO.getAll());
            tfDtCadastro.setText(DateUtil.dateToString(new Date()));
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void limpaCampos() {
        tfNome.setText("");
        tfDtCadastro.setText(String.valueOf(new Date()));
        tfCPF.setText("");
        tfRG.setText("");
